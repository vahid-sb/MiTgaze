...
get the stored information from KMeans clustering analysis
for each media, write the participants under each cluster
...
if __name__ == "__main__":
    ...
    # kmeans
    dir_source = Path('/home/wxiao/Documents/for_Weiyi/analysis_results/kmeans_clustering_results')
