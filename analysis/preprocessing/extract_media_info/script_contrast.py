...
# -*- coding: utf-8 -*-
"""
Created on Fri Oct 30 14:05:16 2020
...
if __name__ == "__main__":
    ...
    from mitgaze.extract_media_features import contrast_analysis
    ...
    dir_save_main = Path(dir_name, 'contrast')
    ...
    if if_parallel:
        ...
        for file_path in all_files:
            contrast_analysis(file_path, dir_save_main, grid_size=(grid_H, grid_W))