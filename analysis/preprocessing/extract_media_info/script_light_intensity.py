...
# -*- coding: utf-8 -*-
"""
Created on Fri Oct 30 13:40:36 2020
...
if __name__ == "__main__":
    ...
    from mitgaze.extract_media_features import light_intensity_analysis
    ...
    dir_save_main = Path(dir_name, 'light_intensity')
    ...
    if if_parallel:
        ...
        Parallel(n_jobs=N_job)\
                (delayed(light_intensity_analysis)
                          (filename,
                          dir_save_main,
        ...
        for file_path in all_files:
            light_intensity_analysis(file_path, dir_save_main, grid_size=(grid_H, grid_W))